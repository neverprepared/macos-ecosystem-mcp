...
import { CreateNoteInputSchema, AppendNoteInputSchema, SearchNotesInputSchema, } from './schemas.js';
import { generateCreateNoteScript, generateAppendNoteScript, generateSearchNotesScript, } from './scripts.js';
function parseNoteOutput(output) {
...
export async function handleNotesTool(request) {
...
export function getNotesToolDefinitions() {
    return [
        {
            name: 'notes_create',
            description: 'Create a new note in Apple Notes app with title and body content. Supports HTML formatting in the body.',
            inputSchema: {
                type: 'object',
                properties: {
                    title: {
        ...
        {
            name: 'notes_append',
            description: 'Append content to an existing note. Can find by note ID (most reliable) or by title with optional folder filter.',
            inputSchema: {
                type: 'object',
                properties: {
                    noteId: {
        ...
        {
            name: 'notes_search',
            description: 'Search notes by keyword in title or body. Supports filtering by folder. Returns up to 100 notes with excerpts.',
            inputSchema: {
                type: 'object',
                properties: {
                    query: {
