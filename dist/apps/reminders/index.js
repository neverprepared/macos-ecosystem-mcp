...
import { AddReminderInputSchema, ListRemindersInputSchema, CompleteReminderInputSchema, SearchRemindersInputSchema, } from './schemas.js';
import { generateAddReminderScript, generateListRemindersScript, generateCompleteReminderScript, generateSearchRemindersScript, } from './scripts.js';
function parseReminderOutput(output) {
...
export async function handleRemindersTool(request) {
...
export function getRemindersToolDefinitions() {
    return [
        {
            name: 'reminders_add',
            description: 'Create a new reminder in Apple Reminders app. Supports title, list, notes, due date, priority (none/low/medium/high), and flagged status.',
            inputSchema: {
                type: 'object',
                properties: {
                    title: {
        ...
        {
            name: 'reminders_list',
            description: 'List reminders from Apple Reminders app with optional filtering by list name and completion status. Returns up to 100 reminders.',
            inputSchema: {
                type: 'object',
                properties: {
                    list: {
        ...
        },
        {
            ...
            description: 'Mark a reminder as completed. Can find by reminder ID (most reliable) or by title with optional list filter.',
            inputSchema: {
                type: 'object',
                properties: {
                    reminderId: {
        ...
        },
        {
            ...
            description: 'Search reminders by keyword in title or notes. Supports filtering by list and completion status.',
            inputSchema: {
                type: 'object',
                properties: {
                    query: {
